...
const EXPL={
 ...
 sbory:[['Что такое сбор','Отдельная тема со своей суммой и своим списком участников. Кто в мероприятии не участвует, за него не платит и в его расходах не участвует.'],
  ['График платежей','Сумма за год разбита на части с датами. Планка «надо к ближайшему сроку» поднимается сама при наступлении каждой даты: сегодня это первый взнос, после 25 августа — первый плюс сентябрьский.'],
  ['Два вида долга','«Не хватает к ближайшему сроку» это то, что нужно внести сейчас; «ещё за год» — остаток до полной суммы, он не просрочен.'],
 ...
 kids:[['Остаток','Сколько денег ребёнка ещё не потрачено: внесено минус своя доля расходов. Расходы сбора делятся поровну между его участниками.'],
  ...
  ['Долги по сборам','Считаются раздельно, переплата по одному сбору не закрывает долг по другому. Нажмите на строку, чтобы увидеть разбивку.'],
